    ...
    <div class="contents">
        ...
        <div class="nav-body">
            ...
            <div class="one card" style="display: block;">
                ...
                <!-- 用户列表 -->
                <div class="userlist">
                    <table class="layui-hide" id="user_table_id" lay-filter="UserTable"
            ...
            <div class="four card" style="display: none;">
                ...
                <div class="commentlist">
                    <table class="layui-hide" id="comment_table_id" lay-filter="CommentTable"
                           style="margin-right: 5%;"></table>
                </div>
            </div>
            <!-- 订单管理 -->
            <div class="five card" style="display: none;">
                ...
                <div class="ticketlist">
                    <table class="layui-hide" id="ticket_table_id" lay-filter="TicketTable"
                           style="margin-right: 5%;"></table>
                </div>
            </div>
            <!-- 票房统计 -->
...
<script type="text/html" id="usertoolbar">
    ...
    <div class="usercheck">
        <input id="userfindtext" type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入用户账号"
               class="layui-input">
...
<script type="text/html" id="commenttoolbar">
    <div class="commentcheck">
        <input id="commentfindtext" type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入用户账号"
               class="layui-input">
...
<script type="text/html" id="tickettoolbar">
    <div class="ticketcheck">
        <input type="button" class="layui-btn-primary layui-btn-sm changeticketBtn" style="width:70px;"
               lay-event="changeticketbtn" value="用户帐号">
        <input id="ticketfindtext" type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入用户账号"
               class="layui-input">
    ...
    function initUser() {
        ...
        layui.use(['laypage', 'layer', 'table'], function () {
            ...
            table.on('tool(UserTable)', function (obj) {
                var data = obj.data;
                if (obj.event === 'detail') {
                    layer.msg('ID：' + data.user_id + '</br>账号：' + data.user_name + '</br>密码：' + data.user_pwd + '</br>邮箱：' + data.user_email, {
                        offset: clientHeight / 4,
                        area: '300px;'
                    });
                } else if (obj.event === 'edit') {
                    layer.alert('确定要对id为“' + JSON.stringify(data.user_id) + '”的用户修改进行保存吗？', {
                            icon: 0,
        ...
        layui.use(['table'], function () {
            ...
            table.on('tool(ScheduleTable)', function (obj) {
                ...
                if (obj.event === 'detail') {
                    ...
                    layer.alert('确定要对id为“' + JSON.stringify(data.schedule_id) + '”的场次修改进行保存吗？', {
                            icon: 0,
                            offset: clientHeight / 5
                        },
                        function () {
                        ...
                        layer.open({
                            ...
                            , yes: function () {
                                ...
                                if ((schedule_cinema == "直接选择或搜索选择") || (schedule_hall == "直接选择或搜索选择") || (schedule_startTime == "") || (schedule_price == "")) {
                                    ...
                                    layer.alert(schedule_cinema + '</br>' + schedule_hall + '</br>' + schedule_startTime + '</br>' + schedule_price, {
                                            icon: 0,
                                            offset: clientHeight / 5
                                        },
                                        function () {
        ...
        layui.use('table', function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , {
                        ...
                        width: 100,
                        unresize: true,
                        templet: '<div>{{d.comment_user.user_name}}</div>'
                    }
            ...
            table.on('tool(CommentTable)', function (obj) {
                ...
                if (obj.event === 'detail') {
                    ...
                    console.log(obj);
                    layer.alert('确定要对id为“' + JSON.stringify(data.comment_id) + '”的评论内容修改进行保存吗？', {
                            icon: 0,
                            offset: clientHeight / 5
                        },
                        function () {
                    ...
                    layer.alert('确定要对id为“' + JSON.stringify(data.comment_id) + '”的评论进行删除吗？', {
                            icon: 0,
                            offset: clientHeight / 5
                        },
                        function () {
    ...
    function initTicket() {
        ...
        layui.use('table', function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , {
                        ...
                        width: 100,
                        unresize: true,
                        templet: '<div>{{d.order_user.user_name}}</div>'
                    }
                    , {
                        ...
                        width: 180,
                        unresize: true,
                        templet: '<div>{{d.order_schedule.schedule_startTime}}</div>'
                    }
                    ...
                    , {
                        ...
                        width: 80,
                        unresize: true,
                        templet: '<div>￥{{d.order_schedule.schedule_price}}</div>'
                    }
                    , {
                        field: 'order_schedule',
                        title: '电影',
                        width: 240,
                        unresize: true,
                        templet: '<div>{{d.order_schedule.schedule_movie.movie_cn_name}}</div>'
                    }
                    , {
                        field: 'order_schedule',
                        title: '影厅',
                        width: 100,
                        unresize: true,
                        templet: '<div>{{d.order_schedule.schedule_hall.hall_name}}</div>'
                    }
                    , {
                        field: 'order_schedule',
                        title: '影院',
                        width: 240,
                        unresize: true,
                        templet: '<div>{{d.order_schedule.schedule_hall.hall_cinema.cinema_name}}</div>'
                    }
                    , {
                        field: 'order_state',
                        title: '订单状态',
                        ...
                        align: 'center',
                        templet: function (d) {
                            if (d.order_state == 1) return '<div style="color:#337ab7">完成</div>'; else if (d.order_state == 0) return '<div style="color:#ef4238">申请退票</div>'; else return '<div style="color:#5cb85c">已退票</div>';
                        }
                    }
            ...
            table.on('tool(TicketTable)', function (obj) {
                var data = obj.data;
                if (obj.event === 'detail') {
                    layer.msg('订单编号：' + data.order_id + '&nbsp;&nbsp;&nbsp;用户：' + data.order_user.user_name + '<br>场次：' + data.order_schedule.schedule_startTime + '&nbsp;&nbsp;&nbsp;位置：' + data.order_position + '<br>电影：《' + data.order_schedule.schedule_movie.movie_cn_name + '》&nbsp;&nbsp;&nbsp;价格：￥' + data.order_schedule.schedule_price + '<br>影院：' + data.order_schedule.schedule_hall.hall_cinema.cinema_name + '&nbsp;&nbsp;&nbsp;影厅：' + data.order_schedule.schedule_hall.hall_name, {
                        offset: clientHeight / 4,
                        area: ['400px', '140px']
                    });
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , {
                        ...
                        width: 240,
                        unresize: true,
                        templet: '<div>{{d.schedule_hall.hall_cinema.cinema_name}}</div>'
                    }
                    , {
                        field: 'schedule_hall',
                        title: '影院地址',
                        width: 300,
                        unresize: true,
                        templet: '<div>{{d.schedule_hall.hall_cinema.cinema_address}}</div>'
                    }
                    , {
                        field: 'schedule_hall',
                        title: '影厅',
                        width: 100,
                        unresize: true,
                        templet: '<div>{{d.schedule_hall.hall_name}}</div>'
                    }
                    , {
                        field: 'schedule_movie',
                        title: '电影',
                        width: 240,
                        unresize: true,
                        templet: '<div>{{d.schedule_movie.movie_cn_name}}</div>'
                    }
                    ...
                    , {
                        ...
                        unresize: true,
                        align: 'center',
                        templet: '<div>{{d.orderList.length}}</div>'
                    }
                    ...
                    , {
                        ...
                        align: 'center',
                        unresize: true,
                        templet: '<div>{{d.orderList.length * d.schedule_price}}</div>'
                    }
