            ...
            $.ajax({
                ...
                success: function (obj) {
                    if (!obj.data) {
                        ...
                        // sessionStorage.set
                        if (obj.data.userRole == 0)
                            window.location.href = urlPageHead + "/mainPage.jsp";
                        else if (obj.data.userRole == 1)
                            window.location.href = urlPageHead + "/manage.jsp";
                    }
                },
                error: function () {
                    alert("network error!");
